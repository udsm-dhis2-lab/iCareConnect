...
@Component({
  selector: "app-view-bin-modal",
  templateUrl: "./view-bin-modal.component.html",
})
export class ViewBinModalComponent implements OnInit {
  dialogData: any;
  ...
  constructor(
    private dialogRef: MatDialogRef<ViewBinModalComponent>,
