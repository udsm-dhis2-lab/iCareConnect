...
@Component({
  selector: "app-nearly-expired-items",
  templateUrl: "./nearly-expired-items.component.html",
  styleUrls: ["./nearly-expired-items.component.scss"],
})
export class NearlyExpiredItemsComponent implements OnInit {
  locationId: string;
