...
@Component({
  selector: "app-stock-out-items",
  templateUrl: "./stock-out-items.component.html",
  styleUrls: ["./stock-out-items.component.scss"],
})
export class StockOutItemsComponent implements OnInit {
  locationId: string;
  stockOutList$: Observable<StockObject[]>;
  ...
  getStockOut(): void {
    this.stockOutList$ = this.stockService.getStockOuts(this.locationId);
  }
}
