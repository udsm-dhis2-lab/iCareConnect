...
import { SharedRenderBatchDefnFieldsComponent } from "./shared-render-batch-defn-fields/shared-render-batch-defn-fields.component";
...
export const labSharedComponents: any[] = [
  ...
  TestOrderInterpretationsComponent,
  SharedBatchRegistrationComponent,
  SharedBatchSetFormComponent,
  SharedBatchFormComponent,
