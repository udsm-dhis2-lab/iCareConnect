...
@Component({
  selector: "app-patient-list-new",
  templateUrl: "./patient-list-new.component.html",
  styleUrls: ["./patient-list-new.component.scss"],
})
export class PatientListNewComponent implements OnInit, OnChanges {
