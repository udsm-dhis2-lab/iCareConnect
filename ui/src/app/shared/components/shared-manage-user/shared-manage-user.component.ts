...
@Component({
  ...
  templateUrl: "./shared-manage-user.component.html",
  styleUrls: ["./shared-manage-user.component.scss"],
})
export class SharedManageUserComponent implements OnInit {
  @Input() user: any;
          ...
          if (response && !response?.error) {
            ...
            this.locationService
              .getLocationsByTagNames(
                ["Treatment+Room", "Module+Location", "Login+Location"],
                {
                  limit: 100,
                  startIndex: 0,
