...
export class SystemUsersService {
  ...
  getUserById(id: string): Observable<UserGetFull> {
    const url = `user/${id}?v=custom:(uuid,display,privileges,roles,username,userProperties,retired,person:(uuid,display,attributes,birthdate,gender,display,preferredName,preferredAddress))`;
