...
@Ignore
public class NHIFServiceE2ETest extends BillingTestBase {
	
	//@InjectMocks
	NHIFServiceImpl basicNHIFService;
	...
	public void initMockito() throws Exception {
		...
		adminService.setGlobalProperty(NHIFConfig.FACILITY_CODE, "06697");
		...
		basicNHIFService = new NHIFServiceImpl();
		this.setUpAdvisors();
	}
