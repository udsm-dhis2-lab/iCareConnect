...
/**
 * Home object for domain model class StReorderLevel.
 * 
 * @see org.openmrs.module.icare.core.dao.StReorderLevel
 * @author Hibernate Tools
 */

public class ReorderLevelDAO extends BaseDAO<ReorderLevel> {
