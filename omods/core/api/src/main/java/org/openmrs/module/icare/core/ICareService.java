...
public interface ICareService extends OpenmrsService {
	...
	List<Map<String, Object>> getPatientVisitsByIdentifier(String id, String idType, String referralNumber, Integer numberOfVisits)
	        throws Exception;
	
	Map<String, Object> sendReferralDataToMediator(String uuid) throws Exception;
	
	String getSharedRecordsFromExternalMediator(String hfrCode, String id, String idType, String referralNumber) throws Exception;
}
