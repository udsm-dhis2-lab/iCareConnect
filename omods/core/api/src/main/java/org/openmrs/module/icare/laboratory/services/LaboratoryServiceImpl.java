...
public class LaboratoryServiceImpl extends BaseOpenmrsService implements LaboratoryService {
	...
	public StorageType deleteStorageType(String storageTypeUuid, String reason) throws Exception {
		...
		if (linkedStorageCount > 0) {
			throw new Exception("Storage type '" + existingStorageType.getName() + "' is still associated with "
			        + linkedStorageCount + " storage(s). Remove or reassign the linked storages first.");
		}
