...
public class BillingControllerAPITest extends BaseResourceControllerTest {
	...
	public void testAShouldNotHavePendingInvoices() throws Exception {
		...
		// When
		MockHttpServletRequest newGetRequest = newGetRequest("billing/invoice",
				new Parameter("patient", patient.getUuid()));
	...
	public void testAShouldNoPayments() throws Exception {
		...
		// When
		MockHttpServletRequest newGetRequest = newGetRequest("billing/payment",
				new Parameter("patient", patient.getUuid()));
		MockHttpServletResponse handle = handle(newGetRequest);
	...
	public void testAutomaticFullDiscountCreation() throws Exception {
		...
		Double totalPrice = invoice.getInvoiceItems().get(1).getPrice()
				* invoice.getInvoiceItems().get(1).getQuantity();
