...
//								 allocation.setConceptSets(conceptSets);
	...
	public Map<String, Object> saveMachineObservations(@RequestBody Map<String, Object> machinePayload) throws Exception {
		...
		List<Map<String, Object>> observations = (List<Map<String, Object>>) machinePayload.getOrDefault("observations", new ArrayList<>());
			  ...
			  // System.out.println for debugging the attributes
    System.out.println("Sample: " + sample);
    System.out.println("Test: " + test);
    System.out.println("Observations: " + observations);
    System.out.println("Mapped Parameters: " + mappedParameters);
    System.out.println("Formatted Results: " + formattedResults);
    System.out.println("Obs With Issues: " + obsWithIssues);
	...
	private void processSampleOrders(Sample sample, Map<String, Object> test, List<Map<String, Object>> observations,
		...
		if (sampleOrders == null || sampleOrders.isEmpty()) {
			System.out.println("No sample orders found for the sample");
		}
	...
	private void processTestAllocations(SampleOrder sampleOrder, List<Map<String, Object>> observations, Concept concept,
		...
		System.out.println("Processing Test Allocations for concept: " + concept);
		System.out.println("Test Allocations: " + testAllocations.size());
