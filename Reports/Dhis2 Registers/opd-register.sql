...
-- Addressing Height
-- LEFT JOIN obs ob2 ON ob2.order_id=test_order_order.order_id AND ob2.concept_id=165860
 -- LEFT JOIN concept_name Height_result_concept_name ON Height_result_concept_name.concept_id=165860
